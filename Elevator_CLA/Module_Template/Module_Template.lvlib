...
<Library LVVersion="26008000">
	...
	<Item Name="Public API" Type="Folder">
		<Item Name="API_Template.vit" Type="VI" URL="../Public API/API_Template.vit"/>
		<Item Name="Init.vi" Type="VI" URL="../Public API/Init.vi"/>
		<Item Name="Error.vi" Type="VI" URL="../Public API/Error.vi"/>
		<Item Name="Exit.vi" Type="VI" URL="../Public API/Exit.vi"/>
	</Item>
	<Item Name="Private Control" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		<Item Name="Module Action.ctl" Type="VI" URL="../Private Control/Module Action.ctl"/>
		<Item Name="Queue Element.ctl" Type="VI" URL="../Private Control/Queue Element.ctl"/>
		<Item Name="Queue FGV Action.ctl" Type="VI" URL="../Private Control/Queue FGV Action.ctl"/>
	</Item>
	<Item Name="Private VIs" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		<Item Name="Queue COMM Dequeue.vi" Type="VI" URL="../Private VIs/Queue COMM Dequeue.vi"/>
		<Item Name="Queue COMM Enqueue.vi" Type="VI" URL="../Private VIs/Queue COMM Enqueue.vi"/>
		<Item Name="Queue FGV.vi" Type="VI" URL="../Private VIs/Queue FGV.vi"/>
		<Item Name="Pre-loop Init.vi" Type="VI" URL="../Private VIs/Pre-loop Init.vi"/>
	</Item>
	<Item Name="Public Control" Type="Folder">
		<Item Name="Module Data.ctl" Type="VI" URL="../Public Control/Module Data.ctl"/>
	</Item>
	<Item Name="Module Main.vi" Type="VI" URL="../Module Main.vi"/>
</Library>
